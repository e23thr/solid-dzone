...
// src/createDropzone.tsx
exports.createDropzone = (props = defaultProps) => {
  const {
    disabled,
    multiple,
    accept,
  ...
  const [isFileDialogActive, setIsFileDialogActive] = solidJs.createSignal(false);
  const [errors, setErrors] = solidJs.createSignal({});
...
exports.default = exports.createDropzone;
